                        ...
                        <table id="branch" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td><?php echo $row->member_id ?? '<span class="text-dark fw-bold">--</span>'; ?></td>
                                        <?php
                                        ...
                                        <?php
                                            ...
                                            # code...
                                        ?>
                                            <td class="text-dark">Not Checked</td>
                                        <?php  } ?>
